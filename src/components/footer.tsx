        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://tiktok.com" className="hover:text-gray-400">
                <svg
              ...
              <Link href="https://snapchat.com" className="hover:text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/vip-tables" className="hover:text-gray-400">
                  VIP Tables
                </Link>
              </li>
              <li>
